sap.ui.define([
	...
	return Controller.extend("Mobile.Mobilestore.controller.serviceBilling", {
		...
		onSubmit: function (oevent) {
			...
			doc.line(60, 80, 60, 150);
			doc.text('Description/Accesories', 65, 90);

			doc.line(140, 80, 140, 150);
			doc.text('Accesories Price', 145, 90);

			doc.line(190, 80, 190, 150);
			doc.text('Service Charge', 192, 90);

			doc.line(230, 80, 230, 150);
			doc.text('Total Amount', 235, 90);
			doc.rect(16, 150, 263, 20);
			//	doc.line(16, 88, 279, 88);
			doc.setFontType("normal");
			doc.setFontSize(15);
			doc.setTextColor(0, 0, 0);

			doc.text(imei, 23, 110);
			doc.text(issue, 90, 110);
			doc.text(accesories, 90, 120);
			doc.text(aprice, 165, 110);
			doc.text(sprice, 198, 110);
			doc.text(tprice, 245, 110);
			doc.text(edate, 150, 162);
			doc.text('Estimated Delivery Date:', 65, 162);
